...
import { AppBottomSheet, BottomSheetFlatList } from '../ui/AppBottomSheet';
...
export function ReactionDetails({
  ...
  return (
    <AppBottomSheet visible={visible} onClose={onClose} snapPoints={SNAP_POINTS}>
      <View style={styles.content}>
        <Text style={[styles.title, { color: theme.textPrimary }]}>Reactions</Text>

        {/* Emoji filter tabs (horizontal — doesn't fight the sheet's vertical pan) */}
