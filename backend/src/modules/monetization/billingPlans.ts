...
const ADDON_CATALOG = [
  ...
  { id: 'chat_pack_s',      name: 'Chat Pack S (10 slots)',       priceInr: 79,  description: 'Legacy — 10 additional introductions.', chatSlotsAdded: 10 },
  { id: 'chat_pack_m',      name: 'Chat Pack M (25 slots)',       priceInr: 149, description: 'Legacy — 25 additional introductions.', chatSlotsAdded: 25 },
  { id: 'chat_pack_l',      name: 'Chat Pack L (50 slots)',       priceInr: 249, description: 'Legacy — 50 additional introductions.', chatSlotsAdded: 50 },
